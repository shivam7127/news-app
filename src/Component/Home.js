...
function Home(props) {
    ...
    async function getAPIData() {
        let response = await fetch(`https://newsapi.org/v2/everything?q=${props.q}&language=${props.language}&page=${page}&sortBy=publishedAt&apiKey${process.env.REACT_APP_API}`)
